                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="@error('name') is-invalid @enderror form-control" value="{{$user->name}}">
                                @error('name')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="name" class="@error('email') is-invalid @enderror form-control" value="{{$user->email}}">
                                @error('email')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
